...
const mycurrentURL = `https://api.openweathermap.org/data/2.5/weather?lat=${myLat}&lon=${myLong}&appid=${myKey}&units=imperial`
...
//   try {
//     const response = await fetch(mycurrentURL);
//     if (response.ok) {
...
// SINCE WE ARE GOING TO GRAB 2 URLS, DO IT THIS WAY 
async function apiFetch() {
  try {
