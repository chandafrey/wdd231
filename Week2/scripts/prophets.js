...
// Create a async defined function named 
// "getProphetData" to fetch data from the 
...
// CREATE displayProphets FUNCTION to create prophet cards
// Define a function expression named "displayProphets" that handles a 
// single parameter named "prophets" somewhere in your js file. 
// Use an arrow expression to contain statements that will process 
// the parameter value and build a card for each prophet.
function displayProphets(prophets) {
    ...
    // create a <p> for birthplace
    let birthPlace = document.createElement('p');
    // create a <p> for date of birth 
